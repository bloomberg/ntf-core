...
NTCCFG_INLINE
void DeflateContext::setCompressionType(ntca::CompressionType::Value value)
{
...
NTCCFG_INLINE
ntca::CompressionType::Value DeflateContext::compressionType() const
{
...
NTCCFG_INLINE
const bdlb::NullableValue<ntca::Checksum>& DeflateContext::checksum() const
{
    return d_checksum;
}
