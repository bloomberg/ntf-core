...
BSLS_IDENT_RCSID(ntca_receiveevent_cpp, "$Id$ $CSID$")
...
bool ReceiveEvent::equals(const ReceiveEvent& other) const
{
    return (d_type == other.d_type && d_context == other.d_context);
}

bool ReceiveEvent::less(const ReceiveEvent& other) const
{
...
bsl::ostream& ReceiveEvent::print(bsl::ostream& stream,
                                  int           level,
