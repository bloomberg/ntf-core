...
#ifndef INCLUDED_NTCA_DRIVERCONFIG
#define INCLUDED_NTCA_DRIVERCONFIG
...
/// Describe the configuration of a driver.
///
/// @par Implementations
/// Drivers may be implemented by one of a number of possible operating system
/// APIs or third-party libraries. The following table describes which driver
/// names are supported on each platform.
///
/// +-----------+-----------------------------------------------------------+
...
/// +-----------+-----------------------------------------------------------+
/// | Windows   | "select", "poll", "iocp" (default)                        |
/// +-----------+-----------------------------------------------------------+
///
/// @par Attributes
...
///
/// @li @b metricName:
/// The name of the metrics collected by the driver.
///
/// @li @b minThreads:
/// The minimum number of threads expected to run the driver.
///
/// @li @b maxThreads:
/// The maximum number of threads allowed to run the driver.
///
...
class DriverConfig
{
  ...
  public:
    ...
    explicit DriverConfig(bslma::Allocator* basicAllocator = 0);
    ...
    /// 'basicAllocator' used to supply memory. If 'basicAllocator' is 0,
    /// the currently installed default allocator is used.
    DriverConfig(const DriverConfig& original,
    ...
    /// Set the name of metrics collected by the driver to the specified
    /// 'value'.
    void setMetricName(const bsl::string& value);

    /// Set the minimum number of threads expected to run the driver to the
    /// specified 'value'.
    void setMinThreads(bsl::size_t value);

    /// Set the maximum number of threads allowed to run the driver to the
    /// specified 'value'.
    ...
    /// Return the name of metrics collected by the driver.
    const bdlb::NullableValue<bsl::string>& metricName() const;

    /// Return the minimum number of threads expected to run the driver.
    const bdlb::NullableValue<bsl::size_t>& minThreads() const;

    /// Return the maximum number of threads allowed to run the driver.
    ...
    bool equals(const DriverConfig& other) const;

    /// Return true if the value of this object is less than the value of
    /// the specified 'other' object, otherwise return false.
    bool less(const DriverConfig& other) const;
...
void hashAppend(HASH_ALGORITHM& algorithm, const DriverConfig& value);
