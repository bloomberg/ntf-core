...
BSLS_IDENT_RCSID(ntca_encryptionkeystoragedescriptor_cpp, "$Id$ $CSID$")
...
EncryptionKeyStorageDescriptor::EncryptionKeyStorageDescriptor(
...
EncryptionKeyStorageDescriptor& EncryptionKeyStorageDescriptor::operator=(
...
void EncryptionKeyStorageDescriptor::reset()
{
    if (d_type == e_PATH) {
        d_path.object().~PathType();
    }
...
bsl::string& EncryptionKeyStorageDescriptor::makePath()
{
    if (d_type == e_PATH) {
        d_path.object().clear();
    }
...
bsl::string& EncryptionKeyStorageDescriptor::makePath(const bsl::string& value)
{
    if (d_type == e_PATH) {
        d_path.object() = value;
    }
...
bsl::vector<char>& EncryptionKeyStorageDescriptor::makeData()
{
    if (d_type == e_DATA) {
        d_data.object().clear();
    }
...
bsl::string& EncryptionKeyStorageDescriptor::path()
{
    BSLS_ASSERT(d_type == e_PATH);
    return d_path.object();
}

bsl::vector<char>& EncryptionKeyStorageDescriptor::data()
{
    BSLS_ASSERT(d_type == e_DATA);
    return d_data.object();
}

const bsl::string& EncryptionKeyStorageDescriptor::path() const
{
    BSLS_ASSERT(d_type == e_PATH);
    return d_path.object();
}

const bsl::vector<char>& EncryptionKeyStorageDescriptor::data() const
{
    BSLS_ASSERT(d_type == e_DATA);
    return d_data.object();
}

bool EncryptionKeyStorageDescriptor::isUndefined() const
{
    return d_type == e_UNDEFINED;
}

bool EncryptionKeyStorageDescriptor::isPath() const
{
    return d_type == e_PATH;
}

bool EncryptionKeyStorageDescriptor::isData() const
{
    return d_type == e_DATA;
}

bool EncryptionKeyStorageDescriptor::equals(
    const EncryptionKeyStorageDescriptor& other) const
{
...
bool EncryptionKeyStorageDescriptor::less(
    const EncryptionKeyStorageDescriptor& other) const
{
    if (d_type != other.d_type) {
        return false;
...
bsl::ostream& EncryptionKeyStorageDescriptor::print(bsl::ostream& stream,
                                                    int           level,
