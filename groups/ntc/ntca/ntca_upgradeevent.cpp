...
BSLS_IDENT_RCSID(ntca_upgradeevent_cpp, "$Id$ $CSID$")
...
bool UpgradeEvent::equals(const UpgradeEvent& other) const
{
    return (d_type == other.d_type && d_context == other.d_context);
}

bool UpgradeEvent::less(const UpgradeEvent& other) const
{
...
bsl::ostream& UpgradeEvent::print(bsl::ostream& stream,
                                  int           level,
