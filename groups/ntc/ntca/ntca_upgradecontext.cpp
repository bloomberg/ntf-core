...
BSLS_IDENT_RCSID(ntca_upgradecontext_cpp, "$Id$ $CSID$")
...
bool UpgradeContext::equals(const UpgradeContext& other) const
{
    return (d_error == other.d_error &&
            d_errorDescription == other.d_errorDescription);
}

bool UpgradeContext::less(const UpgradeContext& other) const
{
...
bsl::ostream& UpgradeContext::print(bsl::ostream& stream,
                                    int           level,
