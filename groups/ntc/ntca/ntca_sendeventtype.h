...
#ifndef INCLUDED_NTCA_SENDEVENTTYPE
#define INCLUDED_NTCA_SENDEVENTTYPE
...
/// Enumerate the send event types.
///
/// @par Thread Safety
...
struct SendEventType {
  public:
    ...
    enum Value {
        ...
        /// An error has been detected during the send operation.
        e_ERROR = 1
    };
