...
#ifndef INCLUDED_NTCA_SHUTDOWNEVENTTYPE
#define INCLUDED_NTCA_SHUTDOWNEVENTTYPE
...
/// Enumerate the shutdown event types.
///
/// @par Thread Safety
/// This struct is thread safe.
///
/// @ingroup module_ntci_operation_shutdown
struct ShutdownEventType {
  public:
    /// Enumerate the shutdown event types.
    enum Value {
...
///
/// @related ntca::ShutdownEventType
