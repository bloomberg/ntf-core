...
#ifndef INCLUDED_NTCA_ENCRYPTIONCERTIFICATESTORAGEDESCRIPTOR
#define INCLUDED_NTCA_ENCRYPTIONCERTIFICATESTORAGEDESCRIPTOR
...
/// Describe the contents of the storage of a certificate.
///
/// @details
...
///
/// @li @b path:
/// The path to the stored certificate.
///
/// @li @b literal:
/// The literal data of the stored certificate.
///
/// @par Thread Safety
/// This class is not thread safe.
///
/// @ingroup module_ntci_encryption
class EncryptionCertificateStorageDescriptor
{
  ...
  public:
    /// Create a new certificate storage descriptor having the default value.
    /// Optionally specify a 'basicAllocator' used to supply memory. If
    /// 'basicAllocator' is 0, the currently installed default allocator is
    /// used.
    explicit EncryptionCertificateStorageDescriptor(
        bslma::Allocator* basicAllocator = 0);

    /// Create a new certificate storage descriptor having the same value as
    ...
    EncryptionCertificateStorageDescriptor& operator=(
        const EncryptionCertificateStorageDescriptor& other);
    ...
    bool equals(const EncryptionCertificateStorageDescriptor& other) const;

    /// Return true if the value of this object is less than the value of the
    /// specified 'other' object, otherwise return false.
    bool less(const EncryptionCertificateStorageDescriptor& other) const;
...
///
/// @related ntca::EncryptionCertificateStorageDescriptor
...
void hashAppend(HASH_ALGORITHM&                               algorithm,
                const EncryptionCertificateStorageDescriptor& value);
