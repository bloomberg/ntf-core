...
BSLS_IDENT_RCSID(ntca_bindevent_cpp, "$Id$ $CSID$")
...
bool BindEvent::equals(const BindEvent& other) const
{
    return (d_type == other.d_type && d_context == other.d_context);
}

bool BindEvent::less(const BindEvent& other) const
{
...
bsl::ostream& BindEvent::print(bsl::ostream& stream,
                               int           level,
