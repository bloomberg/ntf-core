...
BSLS_IDENT_RCSID(ntca_getportevent_cpp, "$Id$ $CSID$")
...
bool GetPortEvent::equals(const GetPortEvent& other) const
{
    return (d_type == other.d_type && d_context == other.d_context);
}

bool GetPortEvent::less(const GetPortEvent& other) const
{
...
bsl::ostream& GetPortEvent::print(bsl::ostream& stream,
                                  int           level,
