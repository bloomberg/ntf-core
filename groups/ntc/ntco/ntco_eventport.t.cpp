...
#define NTCO_EVENTPORT_TEST_SHUTDOWN_WRITE 1

// Uncomment to enable testing of shutting down reads.
#define NTCO_EVENTPORT_TEST_SHUTDOWN_READ 0
...
void execute(bool autoManage, bslma::Allocator* allocator)
{
    ...
    bsl::shared_ptr<ntci::Reactor> reactor =
        reactorFactory->createReactor(reactorConfig, user, allocator);
...
#if NTCO_EVENTPORT_TEST_SHUTDOWN_WRITE
...
#if NTCO_EVENTPORT_TEST_SHUTDOWN_READ
