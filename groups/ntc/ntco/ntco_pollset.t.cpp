...
#define NTCO_POLLSET_TEST_SHUTDOWN_WRITE 1

// Uncomment to enable testing of shutting down reads.
#define NTCO_POLLSET_TEST_SHUTDOWN_READ 0
...
#if NTCO_POLLSET_TEST_SHUTDOWN_WRITE
...
#if NTCO_POLLSET_TEST_SHUTDOWN_READ
