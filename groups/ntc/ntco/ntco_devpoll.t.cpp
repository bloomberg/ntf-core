...
#define NTCO_DEVPOLL_TEST_SHUTDOWN_WRITE 1

// Uncomment to enable testing of shutting down reads.
#define NTCO_DEVPOLL_TEST_SHUTDOWN_READ 0
...
#if NTCO_DEVPOLL_TEST_SHUTDOWN_WRITE
...
#if NTCO_DEVPOLL_TEST_SHUTDOWN_READ
