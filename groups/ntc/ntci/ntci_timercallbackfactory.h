...
#ifndef INCLUDED_NTCI_TIMERCALLBACKFACTORY
#define INCLUDED_NTCI_TIMERCALLBACKFACTORY
...
class TimerCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~TimerCallbackFactory();

    /// Create a new timer callback to invoke the specified 'function' with
    /// no cancellable authorization mechanism on this object's strand.
    /// Optionally specify a  'basicAllocator' used to supply memory. If
    /// 'basicAllocator' is 0, the currently installed default allocator is
    /// used.
    ntci::TimerCallback createTimerCallback(
        const ntci::TimerFunction& function,
...
NTCCFG_INLINE
ntci::TimerCallback TimerCallbackFactory::createTimerCallback(
    const ntci::TimerFunction& function,
    bslma::Allocator*          basicAllocator)
{
    return ntci::TimerCallback(function, this->strand(), basicAllocator);
}
...
ntci::TimerCallback TimerCallbackFactory::createTimerCallback(
    ...
    bslma::Allocator*                           basicAllocator)
{
    return ntci::TimerCallback(function,
                               authorization,
                               this->strand(),
                               basicAllocator);
}
...
ntci::TimerCallback TimerCallbackFactory::createTimerCallback(
    ...
    bslma::Allocator*                    basicAllocator)
{
    return ntci::TimerCallback(function, strand, basicAllocator);
}
