...
#ifndef INCLUDED_NTCI_CONNECTCALLBACKFACTORY
#define INCLUDED_NTCI_CONNECTCALLBACKFACTORY
...
class ConnectCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~ConnectCallbackFactory();

    /// Create a new connect callback to invoke the specified 'function' with
    /// no cancellable authorization mechanism on this object's strand.
    /// Optionally specify a  'basicAllocator' used to supply memory. If
    /// 'basicAllocator' is 0, the currently installed default allocator is
    /// used.
    ntci::ConnectCallback createConnectCallback(
        const ntci::ConnectFunction& function,
...
NTCCFG_INLINE
ntci::ConnectCallback ConnectCallbackFactory::createConnectCallback(
    const ntci::ConnectFunction& function,
    bslma::Allocator*            basicAllocator)
{
    return ntci::ConnectCallback(function, this->strand(), basicAllocator);
}
...
ntci::ConnectCallback ConnectCallbackFactory::createConnectCallback(
    ...
    bslma::Allocator*                           basicAllocator)
{
    return ntci::ConnectCallback(function,
                                 authorization,
                                 this->strand(),
                                 basicAllocator);
}
...
ntci::ConnectCallback ConnectCallbackFactory::createConnectCallback(
    ...
    bslma::Allocator*                    basicAllocator)
{
    return ntci::ConnectCallback(function, strand, basicAllocator);
}
