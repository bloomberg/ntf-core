...
#ifndef INCLUDED_NTCI_CLOSECALLBACKFACTORY
#define INCLUDED_NTCI_CLOSECALLBACKFACTORY
...
class CloseCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~CloseCallbackFactory();

    /// Create a new close callback to invoke the specified 'function' with
    /// no cancellable authorization mechanism on this object's strand.
    /// Optionally specify a  'basicAllocator' used to supply memory. If
    /// 'basicAllocator' is 0, the currently installed default allocator is
    /// used.
    ntci::CloseCallback createCloseCallback(
        const ntci::CloseFunction& function,
...
NTCCFG_INLINE
ntci::CloseCallback CloseCallbackFactory::createCloseCallback(
    const ntci::CloseFunction& function,
    bslma::Allocator*          basicAllocator)
{
    return ntci::CloseCallback(function, this->strand(), basicAllocator);
}
...
ntci::CloseCallback CloseCallbackFactory::createCloseCallback(
    ...
    bslma::Allocator*                           basicAllocator)
{
    return ntci::CloseCallback(function,
                               authorization,
                               this->strand(),
                               basicAllocator);
}
...
ntci::CloseCallback CloseCallbackFactory::createCloseCallback(
    ...
    bslma::Allocator*                    basicAllocator)
{
    return ntci::CloseCallback(function, strand, basicAllocator);
}
