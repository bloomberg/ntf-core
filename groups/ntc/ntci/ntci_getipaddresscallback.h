...
#ifndef INCLUDED_NTCI_GETIPADDRESSCALLBACK
#define INCLUDED_NTCI_GETIPADDRESSCALLBACK
...
/// get IP address operation completes or fails.
///
...
/// Define a type alias for function invoked when an get IP
/// address operation completes or fails.
///
/// @ingroup module_ntci_operation_resolve
typedef GetIpAddressCallback::FunctionType GetIpAddressFunction;
