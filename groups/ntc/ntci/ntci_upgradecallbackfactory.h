...
#ifndef INCLUDED_NTCI_UPGRADECALLBACKFACTORY
#define INCLUDED_NTCI_UPGRADECALLBACKFACTORY
...
/// Provide an interface to create upgrade callbacks.
///
/// @details
...
class UpgradeCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~UpgradeCallbackFactory();

    /// Create a new upgrade callback to invoke the specified 'function' with
    /// no cancellable authorization mechanism on this object's strand.
    /// Optionally specify a  'basicAllocator' used to supply memory. If
    /// 'basicAllocator' is 0, the currently installed default allocator is
    /// used.
    ntci::UpgradeCallback createUpgradeCallback(
        const ntci::UpgradeFunction& function,
...
NTCCFG_INLINE
ntci::UpgradeCallback UpgradeCallbackFactory::createUpgradeCallback(
    const ntci::UpgradeFunction& function,
    bslma::Allocator*            basicAllocator)
{
    return ntci::UpgradeCallback(function, this->strand(), basicAllocator);
}
...
ntci::UpgradeCallback UpgradeCallbackFactory::createUpgradeCallback(
    ...
    bslma::Allocator*                           basicAllocator)
{
    return ntci::UpgradeCallback(function,
                                 authorization,
                                 this->strand(),
                                 basicAllocator);
}
...
ntci::UpgradeCallback UpgradeCallbackFactory::createUpgradeCallback(
    ...
    bslma::Allocator*                    basicAllocator)
{
    return ntci::UpgradeCallback(function, strand, basicAllocator);
}
