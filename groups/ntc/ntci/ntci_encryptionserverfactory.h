...
#ifndef INCLUDED_NTCI_ENCRYPTIONSERVERFACTORY
#define INCLUDED_NTCI_ENCRYPTIONSERVERFACTORY
...
/// Provide an interface to create encryption servers.
///
/// @par Thread Safety
/// This class is thread safe.
///
/// @ingroup module_ntci_encryption
class EncryptionServerFactory
{
  public:
    /// Destroy this object.
    virtual ~EncryptionServerFactory();
