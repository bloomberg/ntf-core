...
ntci::Concurrent::Execute Concurrent::resume(
    const bsl::shared_ptr<ntci::Executor>& executor)
{
    return Concurrent::Execute(executor);
}

ntci::Concurrent::Bind Concurrent::bind(
...
ntci::Concurrent::Connect Concurrent::connect(
...
ntci::Concurrent::Accept Concurrent::accept(
...
ntci::Concurrent::Send Concurrent::send(
...
ntci::Concurrent::Receive Concurrent::receive(
