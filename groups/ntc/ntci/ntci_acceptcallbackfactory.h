...
#ifndef INCLUDED_NTCI_ACCEPTCALLBACKFACTORY
#define INCLUDED_NTCI_ACCEPTCALLBACKFACTORY
...
class AcceptCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~AcceptCallbackFactory();

    /// Create a new accept callback to invoke the specified 'function' with
    /// no cancellable authorization mechanism on this object's strand.
    /// Optionally specify a  'basicAllocator' used to supply memory. If
    /// 'basicAllocator' is 0, the currently installed default allocator is
    /// used.
    ntci::AcceptCallback createAcceptCallback(
        const ntci::AcceptFunction& function,
...
NTCCFG_INLINE
ntci::AcceptCallback AcceptCallbackFactory::createAcceptCallback(
    const ntci::AcceptFunction& function,
    bslma::Allocator*           basicAllocator)
{
    return ntci::AcceptCallback(function, this->strand(), basicAllocator);
}
...
ntci::AcceptCallback AcceptCallbackFactory::createAcceptCallback(
    ...
    bslma::Allocator*                           basicAllocator)
{
    return ntci::AcceptCallback(function,
                                authorization,
                                this->strand(),
                                basicAllocator);
}
...
ntci::AcceptCallback AcceptCallbackFactory::createAcceptCallback(
    ...
    bslma::Allocator*                    basicAllocator)
{
    return ntci::AcceptCallback(function, strand, basicAllocator);
}
