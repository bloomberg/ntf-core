...
#ifndef INCLUDED_NTCI_GETIPADDRESSCALLBACKFACTORY
#define INCLUDED_NTCI_GETIPADDRESSCALLBACKFACTORY
...
/// Provide an interface to create get IP address callbacks.
///
/// @details
...
class GetIpAddressCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~GetIpAddressCallbackFactory();

    /// Create a new get IP address callback to invoke the specified
    ...
    ntci::GetIpAddressCallback createGetIpAddressCallback(
        const ntci::GetIpAddressFunction& function,
...
NTCCFG_INLINE
ntci::GetIpAddressCallback GetIpAddressCallbackFactory::
    createGetIpAddressCallback(const ntci::GetIpAddressFunction& function,
                               bslma::Allocator* basicAllocator)
{
    return ntci::GetIpAddressCallback(function,
                                      this->strand(),
                                      basicAllocator);
}
...
ntci::GetIpAddressCallback GetIpAddressCallbackFactory::
    createGetIpAddressCallback(const ntci::GetIpAddressFunction&    function,
                               ...
                               bslma::Allocator* basicAllocator)
{
    return ntci::GetIpAddressCallback(function, strand, basicAllocator);
}
