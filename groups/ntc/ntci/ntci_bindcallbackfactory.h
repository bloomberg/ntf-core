...
#ifndef INCLUDED_NTCI_BINDCALLBACKFACTORY
#define INCLUDED_NTCI_BINDCALLBACKFACTORY
...
/// Provide an interface to create bind callbacks.
///
/// @details
...
class BindCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~BindCallbackFactory();

    /// Create a new bind callback to invoke the specified 'function' with
    /// no cancellable authorization mechanism on this object's strand.
    /// Optionally specify a  'basicAllocator' used to supply memory. If
    /// 'basicAllocator' is 0, the currently installed default allocator is
    /// used.
    ntci::BindCallback createBindCallback(
        const ntci::BindFunction& function,
...
NTCCFG_INLINE
ntci::BindCallback BindCallbackFactory::createBindCallback(
    const ntci::BindFunction& function,
    bslma::Allocator*         basicAllocator)
{
    return ntci::BindCallback(function, this->strand(), basicAllocator);
}
...
ntci::BindCallback BindCallbackFactory::createBindCallback(
    ...
    bslma::Allocator*                           basicAllocator)
{
    return ntci::BindCallback(function,
                              authorization,
                              this->strand(),
                              basicAllocator);
}
...
ntci::BindCallback BindCallbackFactory::createBindCallback(
    ...
    bslma::Allocator*                    basicAllocator)
{
    return ntci::BindCallback(function, strand, basicAllocator);
}
...
ntci::BindCallback BindCallbackFactory::createBindCallback(
    ...
    bslma::Allocator*                           basicAllocator)
{
    return ntci::BindCallback(function, authorization, strand, basicAllocator);
}
