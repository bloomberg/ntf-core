...
#ifndef INCLUDED_NTCI_UPGRADECALLBACK
#define INCLUDED_NTCI_UPGRADECALLBACK
...
/// upgrade operation completes or fails.
///
...
/// Define a type alias for function invoked when an upgrade
/// operation completes or fails.
///
/// @ingroup module_ntci_operation_upgrade
typedef UpgradeCallback::FunctionType UpgradeFunction;
