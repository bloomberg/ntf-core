...
#ifndef INCLUDED_NTCI_GETSERVICENAMECALLBACK
#define INCLUDED_NTCI_GETSERVICENAMECALLBACK
...
/// get service name operation completes or fails.
///
...
typedef ntci::Callback<void(const bsl::shared_ptr<ntci::Resolver>& resolver,
    ...
    GetServiceNameCallback;

/// Define a type alias for function invoked when an get
/// service name operation completes or fails.
///
/// @ingroup module_ntci_operation_resolve
typedef GetServiceNameCallback::FunctionType GetServiceNameFunction;
