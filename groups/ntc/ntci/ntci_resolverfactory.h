...
#ifndef INCLUDED_NTCI_RESOLVERFACTORY
#define INCLUDED_NTCI_RESOLVERFACTORY
...
/// Provide an interface to create resolvers.
///
/// @par Thread Safety
...
class ResolverFactory
{
  public:
    ...
    virtual bsl::shared_ptr<ntci::Resolver> createResolver(
