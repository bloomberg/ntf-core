...
#ifndef INCLUDED_NTCI_REACTORFACTORY
#define INCLUDED_NTCI_REACTORFACTORY
...
class ReactorFactory
{
  public:
    ...
    /// Create a new reactor with the specified 'configuration' operating in
    /// the environment of the specified 'user'. Optionally specify
    /// a 'basicAllocator' used to supply memory. If 'basicAllocator' is 0,
    /// the currently installed default allocator is used. Return the error.
    virtual bsl::shared_ptr<ntci::Reactor> createReactor(
