...
#ifndef INCLUDED_NTCI_GETENDPOINTCALLBACKFACTORY
#define INCLUDED_NTCI_GETENDPOINTCALLBACKFACTORY
...
/// Provide an interface to create get endpoint callbacks.
///
/// @details
...
class GetEndpointCallbackFactory
{
  public:
    /// Destroy this object.
    virtual ~GetEndpointCallbackFactory();

    /// Create a new get endpoint callback to invoke the specified
    ...
    ntci::GetEndpointCallback createGetEndpointCallback(
        const ntci::GetEndpointFunction& function,
...
NTCCFG_INLINE
ntci::GetEndpointCallback GetEndpointCallbackFactory::
    createGetEndpointCallback(const ntci::GetEndpointFunction& function,
                              bslma::Allocator*                basicAllocator)
{
    return ntci::GetEndpointCallback(function, this->strand(), basicAllocator);
}

NTCCFG_INLINE
ntci::GetEndpointCallback GetEndpointCallbackFactory::
    createGetEndpointCallback(
        const ntci::GetEndpointFunction&            function,
        const bsl::shared_ptr<ntci::Authorization>& authorization,
        bslma::Allocator*                           basicAllocator)
{
    return ntci::GetEndpointCallback(function,
                                     authorization,
                                     this->strand(),
                                     basicAllocator);
}
...
ntci::GetEndpointCallback GetEndpointCallbackFactory::
    createGetEndpointCallback(const ntci::GetEndpointFunction&     function,
                              ...
                              bslma::Allocator* basicAllocator)
{
    return ntci::GetEndpointCallback(function, strand, basicAllocator);
}
