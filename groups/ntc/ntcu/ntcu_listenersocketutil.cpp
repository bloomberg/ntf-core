...
BSLS_IDENT_RCSID(ntcu_listenersocketutil_cpp, "$Id$ $CSID$")
...
ntsa::Error ListenerSocketUtil::getTransport(ntsa::Transport::Value* result,
...
ntsa::Error ListenerSocketUtil::validateTransport(
