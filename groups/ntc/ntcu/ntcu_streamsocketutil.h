...
#ifndef INCLUDED_NTCU_STREAMSOCKETUTIL
#define INCLUDED_NTCU_STREAMSOCKETUTIL
...
struct StreamSocketUtil {
    ...
    /// stream socket using the specified source or remote 'endpoint'.
    /// Return the error.
    static ntsa::Error getTransport(ntsa::Transport::Value* result,
                                    const ntsa::Endpoint&   endpoint);

    /// Validate that the stream transport used by the specified
    ...
    /// Validate that the specified 'transport' is a valid stream
    /// transport. Return the error.
    static ntsa::Error validateTransport(ntsa::Transport::Value transport);

    /// Validate that the specified 'transport' is a valid stream
    /// transport and the stream transport used by the specified
