...
#ifndef INCLUDED_NTCU_LISTENERSOCKETUTIL
#define INCLUDED_NTCU_LISTENERSOCKETUTIL
...
/// @internal @brief
/// Provide utilities for implementing listener sockets.
///
/// @par Thread Safety
...
struct ListenerSocketUtil {
    ...
    /// listener socket using the specified source or remote 'endpoint'.
    /// Return the error.
    static ntsa::Error getTransport(ntsa::Transport::Value* result,
                                    const ntsa::Endpoint&   endpoint);

    /// Validate that the specified 'transport' is a valid listener
    /// transport. Return the error.
    static ntsa::Error validateTransport(ntsa::Transport::Value transport);

    /// Validate that the specified 'transport' is a valid listener
    /// transport and the listener transport used by the specified
