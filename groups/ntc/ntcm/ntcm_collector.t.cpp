...
//                                 Overview
//                                 --------
// This test driver excercises the functionality to collect and publish
// statistics measured by monitorable objects. The test driver simply verifies
// that the expected number of publications occur, given a known set and type
// of monitorable object. The test driver also demonstrates a sample
// implementation of the 'ntci::MonitorablePublisher' protocol that writes
// a description of each statistic and the object that measured it to standard
// ouput, in tabular form.
//-----------------------------------------------------------------------------
...
int main(int argc, char* argv[])
{
    ...
    case 1: {
        ...
        ntccfg::TestAllocator ta;
        {
            ...
            ntcm::Collector collector(loadCallback, &ta);
