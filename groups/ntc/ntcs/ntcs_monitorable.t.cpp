...
// clang-format off
MonitorableTest::Object::StatisticMetadata
MonitorableTest::Object::STATISTICS[] = {
    {
        "test.object",
         "execute.calls",
    ...
    },
    {
        "test.object",
         "execute.minTime", 
         "Minimum execution time of any call",
         ntci::Monitorable::e_MINIMUM
    },
    {
        "test.object",
         "execute.maxTime", 
         "Maximum execution time of any call",
...
void MonitorableTest::Object::setCurrentTime(
...
ntci::Monitorable::StatisticType MonitorableTest::Object::getFieldType(
    int ordinal) const
{
    if (ordinal < numOrdinals()) {
                                           ...
                                           MonitorableTest::Object* object)
{
         ...
         ++ordinal)
    {
        ...
        NTSCFG_TEST_LOG_DEBUG
            ...
            << object->getFieldPrefix(ordinal) << "  " << bsl::setw(30)
            << bsl::left << object->getFieldName(ordinal) << "  "
            << bsl::setw(22) << bsl::right
            << datum.theArray().data()[ordinal].theInteger64() << "  "
            << bsl::left << object->getFieldDescription(ordinal)
            << NTSCFG_TEST_LOG_END;
    }
}
