...
{
  public:
    enum AttributeIndex { ATTRIBUTE_INDEX_ID = 0, ATTRIBUTE_INDEX_NAME = 1 };

    enum AttributeId { ATTRIBUTE_ID_ID = 0, ATTRIBUTE_ID_NAME = 1 };

    enum Constant { NUM_ATTRIBUTES = 2 };
    ...
    // used.
    TestSecurity(const TestSecurity& original,
...
int TestSecurity::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc = manipulator(&this->id, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ID]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->name, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_NAME]);
    if (rc != 0) {
        return rc;
    }
...
template <typename MANIPULATOR>
int TestSecurity::manipulateAttribute(MANIPULATOR& manipulator,
                                      const char*  name,
                                      int          nameLength)
{
...
int TestSecurity::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->id, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ID]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->name, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_NAME]);
    if (rc != 0) {
        return rc;
    }
...
int TestSecurity::accessAttribute(ACCESSOR& accessor, int id) const
{
    switch (id) {
    case ATTRIBUTE_ID_ID:
        return accessor(this->id, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ID]);
    case ATTRIBUTE_ID_NAME:
...
template <typename ACCESSOR>
int TestSecurity::accessAttribute(ACCESSOR&   accessor,
                                  const char* name,
                                  int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestSecurity)
...
class TestPerson
{
  public:
    ...
    enum Constant { NUM_ATTRIBUTES = 4 };
...
int TestPerson::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc = manipulator(&this->address,
                     ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ADDRESS]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->country,
...
int TestPerson::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    ...
    case ATTRIBUTE_ID_ADDRESS:
        return manipulator(&this->address,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ADDRESS]);
    case ATTRIBUTE_ID_COUNTRY:
        return manipulator(&this->country,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COUNTRY]);
    default:
        return -1;
    };
...
template <typename MANIPULATOR>
int TestPerson::manipulateAttribute(MANIPULATOR& manipulator,
                                    const char*  name,
                                    int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestPerson::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc =
        accessor(this->address, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ADDRESS]);
    if (rc != 0) {
        return rc;
    }

    rc =
        accessor(this->country, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COUNTRY]);
    if (rc != 0) {
        return rc;
    }
...
int TestPerson::accessAttribute(ACCESSOR& accessor, int id) const
{
    ...
    case ATTRIBUTE_ID_NAME:
        return accessor(this->name,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_NAME]);
    case ATTRIBUTE_ID_ADDRESS:
        return accessor(this->address,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ADDRESS]);
    case ATTRIBUTE_ID_COUNTRY:
        return accessor(this->country,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COUNTRY]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestPerson::accessAttribute(ACCESSOR&   accessor,
                                const char* name,
                                int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestPerson)
...
class TestTrade
{
  public:
    ...
    enum Constant { NUM_ATTRIBUTES = 7 };
...
int TestTrade::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc =
        manipulator(&this->buyer, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_BUYER]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->seller,
                     ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SELLER]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->security,
                     ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SECURITY]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->shares,
    ...
    rc =
        manipulator(&this->price, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRICE]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->timestamp,
...
template <typename MANIPULATOR>
int TestTrade::manipulateAttribute(MANIPULATOR& manipulator,
                                   const char*  name,
                                   int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestTrade::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->buyer, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_BUYER]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->seller, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SELLER]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->security,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SECURITY]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->shares, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SHARES]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->price, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRICE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->timestamp,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP]);
    if (rc != 0) {
        return rc;
    }
...
int TestTrade::accessAttribute(ACCESSOR& accessor, int id) const
{
    ...
    case ATTRIBUTE_ID_ID:
        return accessor(this->id, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ID]);
    case ATTRIBUTE_ID_BUYER:
        return accessor(this->buyer,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_BUYER]);
    case ATTRIBUTE_ID_SELLER:
        return accessor(this->seller,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SELLER]);
    case ATTRIBUTE_ID_SECURITY:
        return accessor(this->security,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SECURITY]);
    case ATTRIBUTE_ID_SHARES:
        return accessor(this->shares,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SHARES]);
    case ATTRIBUTE_ID_PRICE:
        return accessor(this->price,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRICE]);
    case ATTRIBUTE_ID_TIMESTAMP:
        return accessor(this->timestamp,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TIMESTAMP]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestTrade::accessAttribute(ACCESSOR&   accessor,
                               const char* name,
                               int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestTrade)
...
BDLAT_DECL_ENUMERATION_TRAITS(ntcf::TestFaultCode)
...
BDLAT_DECL_ENUMERATION_TRAITS(ntcf::TestRole)
...
int TestFault::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc = manipulator(&this->role, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ROLE]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->code, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CODE]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->uri, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_URI]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->description,
...
template <typename MANIPULATOR>
int TestFault::manipulateAttribute(MANIPULATOR& manipulator,
                                   const char*  name,
                                   int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestFault::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->role, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ROLE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->code, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CODE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->uri, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_URI]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->description,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DESCRIPTION]);
    if (rc != 0) {
        return rc;
    }
...
int TestFault::accessAttribute(ACCESSOR& accessor, int id) const
{
    switch (id) {
    case ATTRIBUTE_ID_ROLE:
        return accessor(this->role,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ROLE]);
    case ATTRIBUTE_ID_CODE:
        return accessor(this->code,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CODE]);
    case ATTRIBUTE_ID_URI:
        return accessor(this->uri, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_URI]);
    case ATTRIBUTE_ID_DESCRIPTION:
        return accessor(this->description,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DESCRIPTION]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestFault::accessAttribute(ACCESSOR&   accessor,
                               const char* name,
                               int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestFault)
...
class TestTradeResultValue
{
  public:
    ...
    enum Constant { NUM_SELECTIONS = 2 };
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestTradeResultValue(const TestTradeResultValue& original,
                         bslma::Allocator*           allocator = 0);
...
class TestMessageHeader
{
  public:
    ...
    enum Constant { NUM_ATTRIBUTES = 13 };
...
// 'stream'.
bsl::ostream& operator<<(bsl::ostream&            stream,
                         const TestMessageHeader& object);
...
int TestMessageHeader::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    ...
    case ATTRIBUTE_ID_MESSAGE_TYPE:
        return manipulator(&this->messageType,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_TYPE]);
    ...
    case ATTRIBUTE_ID_MESSAGE_SIZE:
        return manipulator(&this->messageSize,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_SIZE]);
    case ATTRIBUTE_ID_HEADER_SIZE:
        return manipulator(&this->headerSize,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_HEADER_SIZE]);
    case ATTRIBUTE_ID_PRAGMA_SIZE:
        return manipulator(&this->pragmaSize,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRAGMA_SIZE]);
    case ATTRIBUTE_ID_ENTITY_SIZE:
        return manipulator(&this->entitySize,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENTITY_SIZE]);
    ...
    case ATTRIBUTE_ID_COMPRESSION:
        return manipulator(&this->compression,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COMPRESSION]);
    case ATTRIBUTE_ID_CHECKSUM:
        return manipulator(&this->checksum,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CHECKSUM]);
    case ATTRIBUTE_ID_TRANSACTION:
        return manipulator(&this->transaction,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TRANSACTION]);
    ...
    case ATTRIBUTE_ID_DEADLINE:
        return manipulator(&this->deadline,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DEADLINE]);
    default:
        return -1;
    };
...
template <typename MANIPULATOR>
int TestMessageHeader::manipulateAttribute(MANIPULATOR& manipulator,
                                           const char*  name,
                                           int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestMessageHeader::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->messageType,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_TYPE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->messageFlags,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_FLAGS]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->messageSize,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->headerSize,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_HEADER_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->pragmaSize,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRAGMA_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->entitySize,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENTITY_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->serialization,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SERIALIZATION]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->compression,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COMPRESSION]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->checksum,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CHECKSUM]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->transaction,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TRANSACTION]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->clientTimestamp,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CLIENT_TIMESTAMP]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->serverTimestamp,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SERVER_TIMESTAMP]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->deadline,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DEADLINE]);
    if (rc != 0) {
        return rc;
    }
...
int TestMessageHeader::accessAttribute(ACCESSOR& accessor, int id) const
{
    switch (id) {
    case ATTRIBUTE_ID_MESSAGE_TYPE:
        return accessor(this->messageType,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_TYPE]);
    case ATTRIBUTE_ID_MESSAGE_FLAGS:
        return accessor(this->messageFlags,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_FLAGS]);
    case ATTRIBUTE_ID_MESSAGE_SIZE:
        return accessor(this->messageSize,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MESSAGE_SIZE]);
    case ATTRIBUTE_ID_HEADER_SIZE:
        return accessor(this->headerSize,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_HEADER_SIZE]);
    case ATTRIBUTE_ID_PRAGMA_SIZE:
        return accessor(this->pragmaSize,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRAGMA_SIZE]);
    case ATTRIBUTE_ID_ENTITY_SIZE:
        return accessor(this->entitySize,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENTITY_SIZE]);
    case ATTRIBUTE_ID_SERIALIZATION:
        return accessor(this->serialization,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SERIALIZATION]);
    case ATTRIBUTE_ID_COMPRESSION:
        return accessor(this->compression,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COMPRESSION]);
    case ATTRIBUTE_ID_CHECKSUM:
        return accessor(this->checksum,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CHECKSUM]);
    case ATTRIBUTE_ID_TRANSACTION:
        return accessor(this->transaction,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TRANSACTION]);
    case ATTRIBUTE_ID_CLIENT_TIMESTAMP:
        return accessor(
            this->clientTimestamp,
...
template <typename ACCESSOR>
int TestMessageHeader::accessAttribute(ACCESSOR&   accessor,
                                       const char* name,
                                       int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestMessageHeader)
...
class TestAsk
{
  public:
    ...
    enum Constant { NUM_ATTRIBUTES = 6 };
...
template <typename MANIPULATOR>
int TestAsk::manipulateAttribute(MANIPULATOR& manipulator,
                                 const char*  name,
                                 int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
template <typename ACCESSOR>
int TestAsk::accessAttribute(ACCESSOR&   accessor,
                             const char* name,
                             int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestAsk)
...
class TestAcknowledgment
{
  public:
    ...
    enum Constant { NUM_ATTRIBUTES = 0 };
...
template <typename MANIPULATOR>
int TestAcknowledgment::manipulateAttribute(MANIPULATOR& manipulator,
                                            const char*  name,
                                            int          nameLength)
{
    (void)(manipulator);
...
template <typename ACCESSOR>
int TestAcknowledgment::accessAttribute(ACCESSOR&   accessor,
                                        const char* name,
                                        int         nameLength) const
{
    (void)(accessor);
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestAcknowledgment)
...
template <typename MANIPULATOR>
int TestBid::manipulateAttribute(MANIPULATOR& manipulator,
                                 const char*  name,
                                 int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
template <typename ACCESSOR>
int TestBid::accessAttribute(ACCESSOR&   accessor,
                             const char* name,
                             int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestBid)
...
template <typename MANIPULATOR>
int TestSubscription::manipulateAttribute(MANIPULATOR& manipulator,
                                          const char*  name,
                                          int          nameLength)
{
    (void)(manipulator);
...
template <typename ACCESSOR>
int TestSubscription::accessAttribute(ACCESSOR&   accessor,
                                      const char* name,
                                      int         nameLength) const
{
    (void)(accessor);
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestSubscription)
...
{
  public:
    enum AttributeIndex { ATTRIBUTE_INDEX_TRADE = 0 };

    enum AttributeId { ATTRIBUTE_ID_TRADE = 0 };

    enum Constant { NUM_ATTRIBUTES = 1 };
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestPublication(const TestPublication& original,
                    bslma::Allocator*      allocator = 0);
...
int TestPublication::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc =
        manipulator(&this->trade, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TRADE]);
    if (rc != 0) {
        return rc;
    }
...
template <typename MANIPULATOR>
int TestPublication::manipulateAttribute(MANIPULATOR& manipulator,
                                         const char*  name,
                                         int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestPublication::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->trade, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TRADE]);
    if (rc != 0) {
        return rc;
    }
...
template <typename ACCESSOR>
int TestPublication::accessAttribute(ACCESSOR&   accessor,
                                     const char* name,
                                     int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
class TestContent
{
  public:
    ...
    enum Constant { NUM_SELECTIONS = 7 };
...
int TestContent::manipulateSelection(MANIPULATOR& manipulator)
{
    switch (d_selectionId) {
    case SELECTION_ID_BID:
        return manipulator(&d_bid.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_BID]);
    case SELECTION_ID_ASK:
        return manipulator(&d_ask.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_ASK]);
    case SELECTION_ID_TRADE:
        return manipulator(&d_trade.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_TRADE]);
    case SELECTION_ID_SUBSCRIPTION:
        return manipulator(&d_subscription.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_SUBSCRIPTION]);
    case SELECTION_ID_PUBLICATION:
        return manipulator(&d_publication.object(),
    ...
    case SELECTION_ID_FAULT:
        return manipulator(&d_fault.object(),
...
int TestContent::accessSelection(ACCESSOR& accessor) const
{
    switch (d_selectionId) {
    case SELECTION_ID_BID:
        return accessor(d_bid.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_BID]);
    case SELECTION_ID_ASK:
        return accessor(d_ask.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_ASK]);
    case SELECTION_ID_TRADE:
        return accessor(d_trade.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_TRADE]);
    case SELECTION_ID_SUBSCRIPTION:
        return accessor(d_subscription.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_SUBSCRIPTION]);
    case SELECTION_ID_PUBLICATION:
        return accessor(d_publication.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_PUBLICATION]);
    case SELECTION_ID_ACKNOWLEDGMENT:
        return accessor(d_acknowledgment.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_ACKNOWLEDGMENT]);
    case SELECTION_ID_FAULT:
        return accessor(d_fault.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_FAULT]);
    default:
        BSLS_ASSERT(d_selectionId == SELECTION_ID_UNDEFINED);
        return -1;
...
BDLAT_DECL_CHOICE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestContent)
...
int TestSignal::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc =
        manipulator(&this->value, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_VALUE]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->reflect,
    ...
    rc =
        manipulator(&this->delay, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DELAY]);
    if (rc != 0) {
        return rc;
    }
...
template <typename MANIPULATOR>
int TestSignal::manipulateAttribute(MANIPULATOR& manipulator,
                                    const char*  name,
                                    int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestSignal::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->value, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_VALUE]);
    if (rc != 0) {
        return rc;
    }

    rc =
        accessor(this->reflect, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_REFLECT]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->delay, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DELAY]);
    if (rc != 0) {
        return rc;
    }
...
int TestSignal::accessAttribute(ACCESSOR& accessor, int id) const
{
    ...
    case ATTRIBUTE_ID_VALUE:
        return accessor(this->value,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_VALUE]);
    case ATTRIBUTE_ID_REFLECT:
        return accessor(this->reflect,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_REFLECT]);
    case ATTRIBUTE_ID_DELAY:
        return accessor(this->delay,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DELAY]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestSignal::accessAttribute(ACCESSOR&   accessor,
                                const char* name,
                                int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestSignal)
...
{
  public:
    enum AttributeIndex { ATTRIBUTE_INDEX_ACKNOWLEDGE = 0 };

    enum AttributeId { ATTRIBUTE_ID_ACKNOWLEDGE = 0 };
...
int TestControlHeartbeat::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc = manipulator(&this->acknowledge,
...
int TestControlHeartbeat::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    ...
    case ATTRIBUTE_ID_ACKNOWLEDGE:
        return manipulator(&this->acknowledge,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ACKNOWLEDGE]);
    default:
        return -1;
    };
...
template <typename MANIPULATOR>
int TestControlHeartbeat::manipulateAttribute(MANIPULATOR& manipulator,
                                              const char*  name,
                                              int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestControlHeartbeat::accessAttribute(ACCESSOR& accessor, int id) const
{
    switch (id) {
    case ATTRIBUTE_ID_ACKNOWLEDGE:
        return accessor(this->acknowledge,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ACKNOWLEDGE]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestControlHeartbeat::accessAttribute(ACCESSOR&   accessor,
                                          const char* name,
                                          int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestControlHeartbeat)
...
{
  public:
    enum AttributeIndex { ATTRIBUTE_INDEX_ID = 0, ATTRIBUTE_INDEX_VALUE = 1 };

    enum AttributeId { ATTRIBUTE_ID_ID = 0, ATTRIBUTE_ID_VALUE = 1 };
...
template <typename MANIPULATOR>
int TestEcho::manipulateAttribute(MANIPULATOR& manipulator,
                                  const char*  name,
                                  int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
template <typename ACCESSOR>
int TestEcho::accessAttribute(ACCESSOR&   accessor,
                              const char* name,
                              int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestEcho)
...
BDLAT_DECL_ENUMERATION_TRAITS(ntcf::TestControlTransition)
...
class TestControlEncryption
{
  public:
    ...
    enum Constant { NUM_ATTRIBUTES = 3 };
...
int TestControlEncryption::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc = manipulator(&this->transition,
...
template <typename MANIPULATOR>
int TestControlEncryption::manipulateAttribute(MANIPULATOR& manipulator,
                                               int          id)
{
    switch (id) {
    case ATTRIBUTE_ID_ENABLED:
        return manipulator(&this->enabled,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENABLED]);
    case ATTRIBUTE_ID_ACKNOWLEDGE:
        return manipulator(&this->acknowledge,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ACKNOWLEDGE]);
    case ATTRIBUTE_ID_TRANSITION:
        return manipulator(&this->transition,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TRANSITION]);
    default:
        return -1;
    };
...
int TestControlEncryption::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc =
        accessor(this->enabled, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENABLED]);
    if (rc != 0) {
        return rc;
    }
...
int TestControlEncryption::accessAttribute(ACCESSOR& accessor, int id) const
{
    switch (id) {
    case ATTRIBUTE_ID_ENABLED:
        return accessor(this->enabled,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENABLED]);
    case ATTRIBUTE_ID_ACKNOWLEDGE:
        return accessor(this->acknowledge,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ACKNOWLEDGE]);
    case ATTRIBUTE_ID_TRANSITION:
        return accessor(this->transition,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_TRANSITION]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestControlEncryption::accessAttribute(ACCESSOR&   accessor,
                                           const char* name,
                                           int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestControlEncryption)
...
void hashAppend(HASH_ALGORITHM&               algorithm,
                const TestControlCompression& value);
...
template <typename MANIPULATOR>
int TestControlCompression::manipulateAttribute(MANIPULATOR& manipulator,
                                                int          id)
{
    switch (id) {
    case ATTRIBUTE_ID_ENABLED:
...
template <typename ACCESSOR>
int TestControlCompression::accessAttribute(ACCESSOR&   accessor,
                                            const char* name,
                                            int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestControlCompression)
...
int TestControl::manipulateSelection(MANIPULATOR& manipulator)
{
    switch (d_selectionId) {
    case SELECTION_ID_SIGNAL:
        return manipulator(&d_signal.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_SIGNAL]);
    case SELECTION_ID_ECHO:
        return manipulator(&d_echo.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_ECHO]);
    case SELECTION_ID_ENCRYPTION:
        return manipulator(&d_encryption.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_ENCRYPTION]);
    case SELECTION_ID_COMPRESSION:
        return manipulator(&d_compression.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_COMPRESSION]);
    case SELECTION_ID_HEARTBEAT:
        return manipulator(&d_heartbeat.object(),
...
int TestControl::accessSelection(ACCESSOR& accessor) const
{
    switch (d_selectionId) {
    case SELECTION_ID_SIGNAL:
        return accessor(d_signal.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_SIGNAL]);
    case SELECTION_ID_ECHO:
        return accessor(d_echo.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_ECHO]);
    case SELECTION_ID_ENCRYPTION:
        return accessor(d_encryption.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_ENCRYPTION]);
    case SELECTION_ID_COMPRESSION:
        return accessor(d_compression.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_COMPRESSION]);
    case SELECTION_ID_HEARTBEAT:
        return accessor(d_heartbeat.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_HEARTBEAT]);
    case SELECTION_ID_ACKNOWLEDGMENT:
        return accessor(d_acknowledgment.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_ACKNOWLEDGMENT]);
...
BDLAT_DECL_CHOICE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestControl)
...
class TestMessageEntity
{
  public:
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestMessageEntity(const TestMessageEntity& original,
                      bslma::Allocator*        allocator = 0);
...
// 'stream'.
bsl::ostream& operator<<(bsl::ostream&            stream,
                         const TestMessageEntity& object);
...
int TestMessageEntity::manipulateSelection(MANIPULATOR& manipulator)
{
    switch (d_selectionId) {
    case SELECTION_ID_CONTROL:
        return manipulator(&d_control.object(),
                           SELECTION_INFO_ARRAY[SELECTION_INDEX_CONTROL]);
    case SELECTION_ID_CONTENT:
        return manipulator(&d_content.object(),
...
int TestMessageEntity::accessSelection(ACCESSOR& accessor) const
{
    switch (d_selectionId) {
    case SELECTION_ID_CONTROL:
        return accessor(d_control.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_CONTROL]);
    case SELECTION_ID_CONTENT:
        return accessor(d_content.object(),
                        SELECTION_INFO_ARRAY[SELECTION_INDEX_CONTENT]);
    default:
        BSLS_ASSERT(d_selectionId == SELECTION_ID_UNDEFINED);
        return -1;
...
{
  public:
    enum AttributeIndex { ATTRIBUTE_INDEX_URI = 0, ATTRIBUTE_INDEX_FAULT = 1 };

    enum AttributeId { ATTRIBUTE_ID_URI = 0, ATTRIBUTE_ID_FAULT = 1 };
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestMessagePragma(const TestMessagePragma& original,
                      bslma::Allocator*        allocator = 0);
...
// 'stream'.
bsl::ostream& operator<<(bsl::ostream&            stream,
                         const TestMessagePragma& object);
...
int TestMessagePragma::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc =
        manipulator(&this->fault, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_FAULT]);
    if (rc != 0) {
        return rc;
    }
...
template <typename MANIPULATOR>
int TestMessagePragma::manipulateAttribute(MANIPULATOR& manipulator,
                                           const char*  name,
                                           int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestMessagePragma::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->fault, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_FAULT]);
    if (rc != 0) {
        return rc;
    }
...
template <typename ACCESSOR>
int TestMessagePragma::accessAttribute(ACCESSOR&   accessor,
                                       const char* name,
                                       int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
class TestMessageFrame
{
  public:
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestMessageFrame(const TestMessageFrame& original,
                     bslma::Allocator*       allocator = 0);
...
int TestMessageFrame::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    ...
    case ATTRIBUTE_ID_HEADER:
        return manipulator(&this->header,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_HEADER]);
    case ATTRIBUTE_ID_PRAGMA:
        return manipulator(&this->pragma,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRAGMA]);
    case ATTRIBUTE_ID_ENTITY:
        return manipulator(&this->entity,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENTITY]);
    default:
        return -1;
    };
...
template <typename MANIPULATOR>
int TestMessageFrame::manipulateAttribute(MANIPULATOR& manipulator,
                                          const char*  name,
                                          int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestMessageFrame::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->header, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_HEADER]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->pragma, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRAGMA]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->entity, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENTITY]);
    if (rc != 0) {
        return rc;
    }
...
int TestMessageFrame::accessAttribute(ACCESSOR& accessor, int id) const
{
    switch (id) {
    case ATTRIBUTE_ID_HEADER:
        return accessor(this->header,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_HEADER]);
    case ATTRIBUTE_ID_PRAGMA:
        return accessor(this->pragma,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_PRAGMA]);
    case ATTRIBUTE_ID_ENTITY:
        return accessor(this->entity,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENTITY]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestMessageFrame::accessAttribute(ACCESSOR&   accessor,
                                      const char* name,
                                      int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestContext::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc =
        manipulator(&this->error, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ERROR]);
    if (rc != 0) {
        return rc;
    }

    rc =
        manipulator(&this->latencyFromClient,
    ...
    rc =
        manipulator(&this->latencyFromServer,
                    ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_LATENCY_FROM_SERVER]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->latencyOverall,
...
template <typename MANIPULATOR>
int TestContext::manipulateAttribute(MANIPULATOR& manipulator,
                                     const char*  name,
                                     int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestContext::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->error, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ERROR]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->latencyFromClient,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_LATENCY_FROM_CLIENT]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->latencyFromServer,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_LATENCY_FROM_SERVER]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->latencyOverall,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_LATENCY_OVERALL]);
    if (rc != 0) {
        return rc;
    }
...
int TestContext::accessAttribute(ACCESSOR& accessor, int id) const
{
    ...
    case ATTRIBUTE_ID_LATENCY_FROM_SERVER:
        return accessor(
            ...
            ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_LATENCY_FROM_SERVER]);
    case ATTRIBUTE_ID_LATENCY_OVERALL:
        return accessor(this->latencyOverall,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_LATENCY_OVERALL]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestContext::accessAttribute(ACCESSOR&   accessor,
                                 const char* name,
                                 int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestContext)
...
class TestTradeResult
{
  public:
    ...
    enum AttributeId { ATTRIBUTE_ID_CONTEXT = 0, ATTRIBUTE_ID_VALUE = 1 };
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestTradeResult(const TestTradeResult& original,
                    bslma::Allocator*      allocator = 0);
...
int TestTradeResult::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    ...
    case ATTRIBUTE_ID_CONTEXT:
        return manipulator(&this->context,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CONTEXT]);
    case ATTRIBUTE_ID_VALUE:
        return manipulator(&this->value,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_VALUE]);
...
template <typename MANIPULATOR>
int TestTradeResult::manipulateAttribute(MANIPULATOR& manipulator,
                                         const char*  name,
                                         int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestTradeResult::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc =
        accessor(this->context, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CONTEXT]);
    if (rc != 0) {
        return rc;
    }
...
template <typename ACCESSOR>
int TestTradeResult::accessAttribute(ACCESSOR&   accessor,
                                     const char* name,
                                     int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
{
  public:
    enum AttributeIndex { ATTRIBUTE_INDEX_DEADLINE = 0 };

    enum AttributeId { ATTRIBUTE_ID_DEADLINE = 0 };
...
template <typename MANIPULATOR>
int TestOptions::manipulateAttribute(MANIPULATOR& manipulator,
                                     const char*  name,
                                     int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
template <typename ACCESSOR>
int TestOptions::accessAttribute(ACCESSOR&   accessor,
                                 const char* name,
                                 int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_BITWISEMOVEABLE_TRAITS(ntcf::TestOptions)
...
class TestServerConfig
{
  public:
    ...
    enum Constant { NUM_ATTRIBUTES = 20 };
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestServerConfig(const TestServerConfig& original,
                     bslma::Allocator*       allocator = 0);
...
int TestServerConfig::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc = manipulator(&this->driver,
                     ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DRIVER]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->encryption,
    ...
    rc = manipulator(&this->minThreads,
                     ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MIN_THREADS]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->maxThreads,
    ...
    rc =
        manipulator(&this->receiveBufferSize,
                    ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_RECEIVE_BUFFER_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->acceptGreedily,
...
int TestServerConfig::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    ...
    case ATTRIBUTE_ID_DRIVER:
        return manipulator(&this->driver,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DRIVER]);
    case ATTRIBUTE_ID_ENCRYPTION:
        return manipulator(&this->encryption,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENCRYPTION]);
    case ATTRIBUTE_ID_COMPRESSION:
        return manipulator(&this->compression,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COMPRESSION]);
    case ATTRIBUTE_ID_MIN_THREADS:
        return manipulator(&this->minThreads,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MIN_THREADS]);
    case ATTRIBUTE_ID_MAX_THREADS:
        return manipulator(&this->maxThreads,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MAX_THREADS]);
    ...
    case ATTRIBUTE_ID_KEEP_ALIVE:
        return manipulator(&this->keepAlive,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_KEEP_ALIVE]);
    ...
    case ATTRIBUTE_ID_BACKLOG:
        return manipulator(&this->backlog,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_BACKLOG]);
...
template <typename MANIPULATOR>
int TestServerConfig::manipulateAttribute(MANIPULATOR& manipulator,
                                          const char*  name,
                                          int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestServerConfig::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->driver, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DRIVER]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->encryption,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENCRYPTION]);
    if (rc != 0) {
        return rc;
    }
    ...
    rc = accessor(this->minThreads,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MIN_THREADS]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->maxThreads,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MAX_THREADS]);
    if (rc != 0) {
        return rc;
    }
    ...
    rc =
        accessor(this->dynamicLoadBalancing,
                 ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DYNAMIC_LOAD_BALANCING]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->keepAlive,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_KEEP_ALIVE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->keepHalfOpen,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_KEEP_HALF_OPEN]);
    if (rc != 0) {
        return rc;
    }
    ...
    rc =
        accessor(this->backlog, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_BACKLOG]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->blobBufferSize,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_BLOB_BUFFER_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->sendBufferSize,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SEND_BUFFER_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->receiveBufferSize,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_RECEIVE_BUFFER_SIZE]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->acceptGreedily,
                  ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ACCEPT_GREEDILY]);
    if (rc != 0) {
        return rc;
    }
...
int TestServerConfig::accessAttribute(ACCESSOR& accessor, int id) const
{
    ...
    case ATTRIBUTE_ID_NAME:
        return accessor(this->name,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_NAME]);
    case ATTRIBUTE_ID_DRIVER:
        return accessor(this->driver,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DRIVER]);
    case ATTRIBUTE_ID_ENCRYPTION:
        return accessor(this->encryption,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ENCRYPTION]);
    case ATTRIBUTE_ID_COMPRESSION:
        return accessor(this->compression,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_COMPRESSION]);
    case ATTRIBUTE_ID_MIN_THREADS:
        return accessor(this->minThreads,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MIN_THREADS]);
    case ATTRIBUTE_ID_MAX_THREADS:
        return accessor(this->maxThreads,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_MAX_THREADS]);
    case ATTRIBUTE_ID_DYNAMIC_LOAD_BALANCING:
        return accessor(
            this->dynamicLoadBalancing,
            ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_DYNAMIC_LOAD_BALANCING]);
    case ATTRIBUTE_ID_KEEP_ALIVE:
        return accessor(this->keepAlive,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_KEEP_ALIVE]);
    case ATTRIBUTE_ID_KEEP_HALF_OPEN:
        return accessor(this->keepHalfOpen,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_KEEP_HALF_OPEN]);
    case ATTRIBUTE_ID_BACKLOG:
        return accessor(this->backlog,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_BACKLOG]);
    case ATTRIBUTE_ID_BLOB_BUFFER_SIZE:
        return accessor(
            this->blobBufferSize,
    ...
    case ATTRIBUTE_ID_RECEIVE_BUFFER_SIZE:
        return accessor(
            ...
            ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_RECEIVE_BUFFER_SIZE]);
    case ATTRIBUTE_ID_ACCEPT_GREEDILY:
        return accessor(this->acceptGreedily,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_ACCEPT_GREEDILY]);
    case ATTRIBUTE_ID_ACCEPT_QUEUE_LOW_WATERMARK:
        return accessor(
            this->acceptQueueLowWatermark,
...
template <typename ACCESSOR>
int TestServerConfig::accessAttribute(ACCESSOR&   accessor,
                                      const char* name,
                                      int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
class TestAcknowledgmentResultValue
{
  public:
    ...
    // Assign the value of the specified 'other' object to this object.
    // Return a reference to this modifiable object.
    TestAcknowledgmentResultValue& operator=(
...
template <typename HASH_ALGORITHM>
void hashAppend(HASH_ALGORITHM&                      algorithm,
                const TestAcknowledgmentResultValue& value);
...
template <typename MANIPULATOR>
int TestAcknowledgmentResultValue::manipulateSelection(
...
class TestAcknowledgmentResult
{
  public:
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestAcknowledgmentResult(const TestAcknowledgmentResult& original,
                             bslma::Allocator*               allocator = 0);
...
template <typename HASH_ALGORITHM>
void hashAppend(HASH_ALGORITHM&                 algorithm,
                const TestAcknowledgmentResult& value);
...
template <typename MANIPULATOR>
int TestAcknowledgmentResult::manipulateAttribute(MANIPULATOR& manipulator,
                                                  int          id)
{
    switch (id) {
    case ATTRIBUTE_ID_CONTEXT:
...
template <typename ACCESSOR>
int TestAcknowledgmentResult::accessAttribute(ACCESSOR&   accessor,
                                              const char* name,
                                              int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_ENUMERATION_TRAITS(ntcf::TestMessageType)
...
class TestClientConfig
{
  public:
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestClientConfig(const TestClientConfig& original,
                     bslma::Allocator*       allocator = 0);
...
template <typename MANIPULATOR>
int TestClientConfig::manipulateAttribute(MANIPULATOR& manipulator,
                                          const char*  name,
                                          int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
template <typename ACCESSOR>
int TestClientConfig::accessAttribute(ACCESSOR&   accessor,
                                      const char* name,
                                      int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
class TestEchoResultValue
{
  public:
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestEchoResultValue(const TestEchoResultValue& original,
                        bslma::Allocator*          allocator = 0);
...
// Return true if the specified 'lhs' has the same value as the specified
// 'rhs', otherwise return false.
bool operator==(const TestEchoResultValue& lhs,
                const TestEchoResultValue& rhs);
...
class TestEchoResult
{
  public:
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestEchoResult(const TestEchoResult& original,
                   bslma::Allocator*     allocator = 0);
...
template <typename MANIPULATOR>
int TestEchoResult::manipulateAttribute(MANIPULATOR& manipulator,
                                        const char*  name,
                                        int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
template <typename ACCESSOR>
int TestEchoResult::accessAttribute(ACCESSOR&   accessor,
                                    const char* name,
                                    int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_SEQUENCE_WITH_ALLOCATOR_BITWISEMOVEABLE_TRAITS(ntcf::TestEchoResult)
...
class TestFixtureConfig
{
  public:
    ...
    enum AttributeId { ATTRIBUTE_ID_CLIENT = 0, ATTRIBUTE_ID_SERVER = 1 };
    ...
    // If 'basicAllocator' is 0, the currently installed default allocator is
    // used.
    TestFixtureConfig(const TestFixtureConfig& original,
                      bslma::Allocator*        allocator = 0);
...
// 'stream'.
bsl::ostream& operator<<(bsl::ostream&            stream,
                         const TestFixtureConfig& object);
...
int TestFixtureConfig::manipulateAttributes(MANIPULATOR& manipulator)
{
    ...
    rc = manipulator(&this->client,
                     ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CLIENT]);
    if (rc != 0) {
        return rc;
    }

    rc = manipulator(&this->server,
...
int TestFixtureConfig::manipulateAttribute(MANIPULATOR& manipulator, int id)
{
    ...
    case ATTRIBUTE_ID_CLIENT:
        return manipulator(&this->client,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CLIENT]);
    case ATTRIBUTE_ID_SERVER:
        return manipulator(&this->server,
                           ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SERVER]);
    default:
        return -1;
    };
...
template <typename MANIPULATOR>
int TestFixtureConfig::manipulateAttribute(MANIPULATOR& manipulator,
                                           const char*  name,
                                           int          nameLength)
{
    const bdlat_AttributeInfo* attributeInfo =
...
int TestFixtureConfig::accessAttributes(ACCESSOR& accessor) const
{
    ...
    rc = accessor(this->client, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CLIENT]);
    if (rc != 0) {
        return rc;
    }

    rc = accessor(this->server, ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SERVER]);
    if (rc != 0) {
        return rc;
    }
...
int TestFixtureConfig::accessAttribute(ACCESSOR& accessor, int id) const
{
    switch (id) {
    case ATTRIBUTE_ID_CLIENT:
        return accessor(this->client,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_CLIENT]);
    case ATTRIBUTE_ID_SERVER:
        return accessor(this->server,
                        ATTRIBUTE_INFO_ARRAY[ATTRIBUTE_INDEX_SERVER]);
    default:
        return -1;
    };
...
template <typename ACCESSOR>
int TestFixtureConfig::accessAttribute(ACCESSOR&   accessor,
                                       const char* name,
                                       int         nameLength) const
{
    const bdlat_AttributeInfo* attributeInfo =
...
BDLAT_DECL_ENUMERATION_TRAITS(ntcf::TestMessageFlag)
