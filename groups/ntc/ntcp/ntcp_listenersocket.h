...
#ifndef INCLUDED_NTCP_LISTENERSOCKET
#define INCLUDED_NTCP_LISTENERSOCKET
                       ...
                       public ntccfg::Shared<ListenerSocket>
{
  ...
  private:
    ...
    /// Initiate a new accept, if allowed and necessary.
    void privateInitiateAccept(const bsl::shared_ptr<ListenerSocket>& self);

    /// Process the completion of the accepance of a connection from the
    /// backlog identified by the specified 'streamSocketBase'. The behavior
    /// is undefined unless 'd_mutex' is locked.
    void privateCompleteAccept(
    ...
    void privateFailAccept(const bsl::shared_ptr<ListenerSocket>& self,
