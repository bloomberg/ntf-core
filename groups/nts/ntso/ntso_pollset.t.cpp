...
// Provide tests for 'ntso::Pollset'.
class PollsetTest
{
  public:
...
NTSCFG_TEST_FUNCTION(ntso::PollsetTest::verifyCase1)
{
    ...
    bsl::shared_ptr<ntsi::Reactor> reactor =
        ntso::PollsetUtil::createReactor(reactorConfig, NTSCFG_TEST_ALLOCATOR);
...
NTSCFG_TEST_FUNCTION(ntso::PollsetTest::verifyCase2)
{
#if NTSO_POLLSET_ENABLED
...
NTSCFG_TEST_FUNCTION(ntso::PollsetTest::verifyCase3)
{
#if NTSO_POLLSET_ENABLED
