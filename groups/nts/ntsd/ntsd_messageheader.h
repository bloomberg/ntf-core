...
///
/// @li @b crc:
/// The cyclic redundancy check on the entire message contents, including
/// the header.
///
/// @li @b type:
/// The type of message.
...
class MessageHeader
{
  ...
  public:
    ...
    NTSCFG_TYPE_TRAIT_BITWISE_COPYABLE(MessageHeader);

    /// This type's move-constructor and move-assignment operator is equivalent
    /// to copying each byte of the source object's footprint to each
    /// corresponding byte of the destination object's footprint.
    NTSCFG_TYPE_TRAIT_BITWISE_MOVABLE(MessageHeader);
};
