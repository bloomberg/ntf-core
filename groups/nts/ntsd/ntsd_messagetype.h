...
#ifndef INCLUDED_NTSD_MESSAGETYPE
#define INCLUDED_NTSD_MESSAGETYPE
...
struct MessageType {
  public:
    /// Provide an enumeration of the test message types.
    enum Value {
        /// The message type is not defined.
        e_UNDEFINED = 0,

        /// The message a request for a response.
        e_REQUEST = 1,

        /// The message is a response to a request.
        e_RESPONSE = 2,

        /// The message is a one-way communication.
        e_ONE_WAY = 3
    };
