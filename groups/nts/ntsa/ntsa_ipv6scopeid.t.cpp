...
BSLS_IDENT_RCSID(ntsa_ipv6scopeid_t_cpp, "$Id$ $CSID$")
...
// Provide tests for 'ntsa::Ipv6ScopeId'.
class Ipv6ScopeIdTest
{
  public:
    // TODO
...
NTSCFG_TEST_FUNCTION(ntsa::Ipv6ScopeIdTest::verifyCase1)
{
    struct Data {
        const char*   d_text;
...
NTSCFG_TEST_FUNCTION(ntsa::Ipv6ScopeIdTest::verifyCase2)
{
    struct Data {
        bsl::uint16_t d_value;
        const char*   d_text;
