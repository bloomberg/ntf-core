...
BSLS_IDENT_RCSID(ntsa_portoptions_cpp, "$Id$ $CSID$")
...
bool PortOptions::equals(const PortOptions& other) const
{
...
bool PortOptions::less(const PortOptions& other) const
{
...
bsl::ostream& PortOptions::print(bsl::ostream& stream,
                                 int           level,
