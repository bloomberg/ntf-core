...
class CoroutineWhen
{
  ...
  public:
    ...
    CoroutineWhen& operator=(CoroutineWhen&& other) noexcept;
  ...
  private:
    ...
    CoroutineWhen(const CoroutineWhen&) = delete;

    /// This class is not copy-assignable.
    CoroutineWhen& operator=(const CoroutineWhen&) = delete;

  private:
    /// The coroutine context.
    CoroutineWhen<RESULT>::Context* d_context;
...
/// @ingroup module_ntsa
template <typename RESULT>
class CoroutineWhen<RESULT>::Context : public CoroutineReturn<RESULT>
{
  public:
    ...
    /// 'stream'.
    ///
    /// @related ntsa::CoroutineWhen<RESULT>Context
...
/// @ingroup module_ntsa
template <typename RESULT>
class CoroutineWhen<RESULT>::Promise : public CoroutineWhen<RESULT>::Context
{
  public:
    ...
    /// of the coroutine.
    CoroutineWhen<RESULT>::Prolog initial_suspend();

    /// Return an awaitable object that implements the the final suspension
    /// of the coroutine.
    CoroutineWhen<RESULT>::Epilog final_suspend() noexcept;

    /// Return the value to be returned from the coroutine.
    CoroutineWhen<RESULT> get_return_object();
...
/// @ingroup module_ntsa
template <typename RESULT>
class CoroutineWhen<RESULT>::Prolog
{
  public:
    /// Create a new awaitable for the specified 'context'.
    explicit Prolog(CoroutineWhen<RESULT>::Context* context) noexcept;
...
/// @ingroup module_ntsa
template <typename RESULT>
class CoroutineWhen<RESULT>::Epilog
{
  public:
    /// Create a new awaitable for the specified 'context'.
    explicit Epilog(CoroutineWhen<RESULT>::Context* context) noexcept;
...
/// @ingroup module_ntsa
template <typename RESULT>
class CoroutineWhen<RESULT>::Caller
{
  public:
    /// Create a new awaitable for the specified 'context'.
    explicit Caller(CoroutineWhen<RESULT>::Context* context) noexcept;
