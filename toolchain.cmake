...
set(NTF_TOOLCHAIN_VERSION_PATCH 3)
...
elseif (DEFINED ENV{NTF_CONFIGURE_UFID})
    ...
    if("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64"  OR
       ...
       "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "sun4u"   OR
       "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "sparcv9")
...
message(STATUS "NTF Build Toolchain: CMAKE_CXX_STANDARD = ${CMAKE_CXX_STANDARD}")
message(STATUS "NTF Build Toolchain: CMAKE_CXX_STANDARD_REQUIRED = ${CMAKE_CXX_STANDARD_REQUIRED}")
...
if ("${CMAKE_C_STANDARD_REQUIRED}" STREQUAL "")
    set(CMAKE_C_STANDARD_REQUIRED TRUE CACHE STRING "" FORCE)
endif()

set(CMAKE_C_STANDARD_DEFAULT "" CACHE STRING "" FORCE)

if ("${CMAKE_CXX_STANDARD}" STREQUAL "")
    if ("${NTF_TOOLCHAIN_COMPILER_CXX_NAME}" STREQUAL "cl" OR
        "${NTF_TOOLCHAIN_COMPILER_CXX_NAME}" STREQUAL "cl.exe")
